/*
  ...
  - The values [PAUSED] on the enum `ExamStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ExamStatus_new" AS ENUM ('PENDING', 'ONGOING', 'COMPLETED');
